...
> [API リファレンス 02 layers](../../api-guide/02-layers.ja.md) に。
...
それでも詰まったら、 [API リファレンス](../../api-guide/README.ja.md)で該当 mark の
...
scale・theme の制御は [API リファレンス 03 encoding & scale](../../api-guide/03-encoding-scale.ja.md) /
[04 decoration](../../api-guide/04-decoration.ja.md) で、 統計モデルとの連携は
[07 analyze](../../api-guide/07-analyze.ja.md) で深掘りできます。
