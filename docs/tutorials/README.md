...
| Ch | R4DS 章 | dir | 実データ | 状態 |
|---|---|---|---|---|
| 9 | [Layers](https://r4ds.hadley.nz/layers) | [`05-layers`](05-layers/) | mpg | 完了 |
| 10 | [Exploratory data analysis](https://r4ds.hadley.nz/eda) | [`10-eda`](10-eda/) | diamonds / mpg / flights | 完了 |
| 11 | [Communication](https://r4ds.hadley.nz/communication) | [`07-communication`](07-communication/) | mpg | 完了 |
...
| 14 | [Strings](https://r4ds.hadley.nz/strings) | `14-strings` | babynames 等 | 予定 |
| 15 | [Regular expressions](https://r4ds.hadley.nz/regexps) | `15-regexps` | babynames / words | 予定 |
| 16 | [Factors](https://r4ds.hadley.nz/factors) | `16-factors` | gss_cat | 予定 |
| 17 | [Dates and times](https://r4ds.hadley.nz/datetimes) | [`08-datetimes`](08-datetimes/) | flights | 完了 |
| 18 | [Missing values](https://r4ds.hadley.nz/missing-values) | [`09-missing`](09-missing/) | treatment / stocks / health | 完了 |
| 19 | [Joins](https://r4ds.hadley.nz/joins) | [`10-joins`](10-joins/) | nycflights13 5 表 | 完了 |
...
>
> **既知の整理事項**: `09-layers`(旧・緩基準の残骸)は Ch9 が `05-layers` と重複。
> 退役して `05-layers` を正準にする(別途 cabal target も整理)。ディレクトリ番号は
> 将来 R4DS 章番号に揃える可能性あり(現状は dir 名を据え置き・`Ch` 列が正)。
...
- [API リファレンス](../api-guide/README.md)
- [ggplot2 からの移行](../migration-from-ggplot.md)
