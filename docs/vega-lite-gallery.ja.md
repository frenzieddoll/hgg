...
> 比較の総評・5 軸評価は [comparison-vega-lite.md](comparison-vega-lite.ja.md) を参照。
...
> これらは [comparison-vega-lite.md](comparison-vega-lite.ja.md) の「未整備」 とも対応。 B 群は
...
詳細は [comparison-vega-lite.md 軸 4](comparison-vega-lite.ja.md)。
