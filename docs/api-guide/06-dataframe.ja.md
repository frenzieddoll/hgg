...
> [📚 索引](README.ja.md) ｜ [01 quickstart](01-quickstart.ja.md) ｜ [02 layers](02-layers.ja.md) ｜ [03 encoding & scale](03-encoding-scale.ja.md) ｜ [04 decoration](04-decoration.ja.md) ｜ [05 backends](05-backends.ja.md) ｜ **06 dataframe** ｜ [07 analyze](07-analyze.ja.md) ｜ [08 3d](08-3d.ja.md) ｜ [09 appendix](09-appendix.ja.md)
...
> (4 演算子 `<>` / `|>` / `|>>` / `|->` の役割一覧は [演算子早見表](README.ja.md#演算子早見表)。)
...
[02 layers](02-layers.ja.md#index) の mark はすべて列名引数で df から描ける。
...
> (`filter |> ggplot` と同型・[subplot](04-decoration.ja.md#subplots) の patchwork と組み合わせる)。
