...
> [📚 索引](README.md) ｜ [01 quickstart](01-quickstart.md) ｜ [02 layers](02-layers.md) ｜ [03 encoding & scale](03-encoding-scale.md) ｜ [04 decoration](04-decoration.md) ｜ [05 backends](05-backends.md) ｜ [06 dataframe](06-dataframe.md) ｜ **07 analyze** ｜ [08 3d](08-3d.md) ｜ [09 appendix](09-appendix.md)
...
`statModel` で包んだものは `ModelSpec` で、 下の設定を `<>` で合成できる ([04 列挙型早見表](04-decoration.md#enum-tables) と同じ要領)。
...
[`selectPanels`](04-decoration.md#subplots) (panel title = パラメータ名)、 forest は
...
[nested subplots](04-decoration.md#subplots) と組み合わせれば、 PyMC + ArviZ の `az.plot_trace` 群を 1 枚に束ねた
...
抽出子は普通の layer なので、 [04 decoration](04-decoration.md) の装飾や [`subplots`](04-decoration.md#subplots) と自由に組める。
...
(`forestOf`/`traceOf`/`epred`/`dagOf` …) を [`subplots`](04-decoration.md#subplots) で 1 枚に束ねる。
