-- |
-- Module      : Hgg.Plot.Layout.RangeOf
...
import           Hgg.Plot.Spec (ColData (..), ColorEnc (..), Layer (..), MarkKind (..),
                                    Position (..),
